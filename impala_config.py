...
config = {
    'experiment_name': 'Walker2d-v2',
    # Walker2d-v2  Ant-v2 BipedalWalker-v2 Humanoid-v3  HalfCheetah-v2  Swimmer-v3 Hopper-v2
    #==========  remote config ==========
    ...
    'sample_queue_max_size': 32,
    'gamma': 0.99,

    # learning rate adjustment schedule: (train_step, learning_rate)
    'lr_scheduler': [(0, 0.001), (2000, 0.0005), (4000, 0.0001)],
